...
const PDF_PATH = path.join(
  projectRoot,
  'src/rag-data/pdf/S00014-01-000-02_CRIB_WiseGuard_Chi.pdf'
);
  ...
  execute: async ({ context }) => {
    try {
      ...
      const relevantDocs = await vectorStore.similaritySearch(
        ...
        20,  // Reduced number of documents for more focused results
...
export const insurancePlanWorkflow = new Workflow({
  name: 'Insurance Plan Workflow',
